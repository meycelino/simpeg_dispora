...
<div class="page-header">
	<h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Anak <i class="ace-icon fa fa-angle-double-right"></i> Edit &nbsp; <i class="ace-icon fa fa-key icon-animated-vertical bigger-100"></i> Pegawai: <?=$peg['nama']?>  
		<?php
