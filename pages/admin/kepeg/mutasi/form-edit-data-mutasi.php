...
<div class="page-header">
	<h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Mutasi <i class="ace-icon fa fa-angle-double-right"></i> Edit &nbsp; <i class="ace-icon fa fa-key icon-animated-vertical bigger-100"></i> Pegawai: <?=$peg['nama']?>  
		<?php
	...
	<div class="col-xs-12">
		<form action="home-admin.php?page=edit-data-mutasi&id_mutasi=<?=$id_mutasi?>" class="form-horizontal" method="POST" enctype="multipart/form-data" >
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<div class="input-group">
						<input type="text" name="tgl_mutasi" value="<?=$data['tgl_mutasi']?>" class="form-control date-picker" data-date-format="yyyy-mm-dd" />
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="no_mutasi" maxlength="32" value="<?=$data['no_mutasi']?>" class="col-xs-10 col-sm-12"/>
				</div>
			</div>
			<div class="form-group">
