...
<div class="page-header">
	<h1>Data<small><i class="ace-icon fa fa-angle-double-right"></i> Pegawai <i class="ace-icon fa fa-angle-double-right"></i> Edit &nbsp; <i class="ace-icon fa fa-key icon-animated-vertical bigger-100"></i> NIP_<?=$data['nip']?> 
		<?php
	...
	<div class="col-xs-12">
		<form action="home-admin.php?page=edit-data-pegawai&id_peg=<?=$id_peg?>" class="form-horizontal" method="POST" enctype="multipart/form-data" >
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="nip" maxlength="24" value="<?=$data['nip']?>" class="col-xs-10 col-sm-12"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">Nama Pegawai</label>
				<div class="col-sm-6">
					<input type="text" name="nama" maxlength="64" value="<?=$data['nama']?>" class="col-xs-10 col-sm-12"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">Tempat, Tanggal Lahir</label>
				<div class="col-sm-3">
					<input type="text" name="tempat_lhr" maxlength="64" value="<?=$data['tempat_lhr']?>" class="col-xs-10 col-sm-12"/>
				</div>
				<div class="col-sm-3">
					<div class="input-group">
						<input type="text" name="tgl_lhr" value="<?=$data['tgl_lhr']?>" class="form-control date-picker" data-date-format="yyyy-mm-dd" />
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="agama" class="chosen-select form-control" data-placeholder="Choose a Agama...">';    
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="jk" class="chosen-select form-control" data-placeholder="Choose a Jenis Kelamin...">';    
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="gol_darah" class="chosen-select form-control" data-placeholder="Choose a Golongan Darah...">';    
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="status_nikah" class="chosen-select form-control" data-placeholder="Choose a Status Pernikahan...">';    
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="status_kepeg" class="chosen-select form-control" data-placeholder="Choose a Status Kepegawaian...">';    
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<div class="input-group">
						<input type="text" name="tgl_naikpangkat" value="<?=$data['tgl_naikpangkat']?>" class="form-control date-picker" data-date-format="yyyy-mm-dd" />
						<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-6">
					<div class="input-group">
						<input type="text" name="tgl_naikgaji" value="<?=$data['tgl_naikgaji']?>" class="form-control date-picker" data-date-format="yyyy-mm-dd" />
						<span class="input-group-addon"><i class="fa fa-calendar bigger-110"></i></span>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-6">
					<textarea name="alamat" class="form-control" maxlength="255"><?=$data['alamat']?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">No. Telp</label>
				<div class="col-sm-6">
					<input type="text" name="telp" maxlength="12" value="<?=$data['telp']?>" class="col-xs-10 col-sm-12"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right">Email</label>
				<div class="col-sm-6">
					<input type="text" name="email" maxlength="64" value="<?=$data['email']?>" class="col-xs-10 col-sm-12"/>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-offset-3 col-md-6">
					...
					<a type="button" class="btn btn-white btn-danger btn-bold" href="home-admin.php?page=form-view-data-pegawai"><i class="ace-icon fa fa-times bigger-120"></i>Cancel</a>
				</div>
			</div>
		</form>
	</div>
